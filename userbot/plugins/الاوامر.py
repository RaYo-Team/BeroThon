...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 BERO𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/YYYIIY) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO𝙏𝙃𝙊𝙉](t.me/YYYIIY) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 BERO𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/YYYIIY) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO𝙏𝙃𝙊𝙉](t.me/YYYIIY) 𓆪"
...
########################  SOURCE BERO𝙏𝙃𝙊𝙉 ~ BY: ZelZal (@YYYIIY)  ########################
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/YYYIIY) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO](t.me/YYYIIY) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/YYYIIY) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO](t.me/YYYIIY) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/YYYIIY) 🧸♥️𓆪\n**𓍹━─━─━─━─BERO─━─━─━─━𓍻**\n **𓄂**╺  𝑫𝑬𝑽 ❶╰──► @ZZZZl1l ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❷╰──► 𝒅𝒆𝒆𝒑 𝒘𝒐𝒖𝒏𝒅⍣°.²°²¹🦋… ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❸╰──► @HHHl1l ༗")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 BERO - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/YYYIIY) 🗑♻️𓆪\n**𓍹━─━─━─━─BERO─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def zed(mention):
    ...
    await edit_or_reply(mention, f"**🚹 ╎ المستخدم ⪼ • ** [{zedth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه ورع القـروب .. بنجـاح😹🙇🏻.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
async def zed(mention):
    ...
    my_first = me.first_name
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚺 ╎ المستخدمه ⪼ • ** [{zedth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـها مـزة الكروب .. بنجـاح 🥳💃.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
...
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 BERO - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧBEROⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @ZlZZl77 ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @zzzzl1l ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧBEROⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            alive,
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧBEROⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @ZlZZl77 ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @zzzzl1l ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧBEROⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )
